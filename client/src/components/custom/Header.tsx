...
function Header() {
  return (
    <div className="flex-1 shadow-md shadow-gray-100 bg-white h-16 flex items-center justify-between px-2">
      <HeaderSearchInput />
      <Menu />
    </div>
  );
...
const Menu = () => {
  return <div className="flex gap-1 items-center">
     <EnvelopeIcon className="h-5  text-red-500 "/>
     <BellIcon className="h-5  text-red-500 "/> 
