  ...
  return (
    <div className="pb-10">
      ...
      <div className="px-6">
       ...
       <Calendar onChange={onChange} value={value} className={"w-[90%]  h-[90%] self-center"} />
       </div>
       <div className="flex-1 bg-white flex flex-col py-3 ">
        <p className="font-semibold text-lg px-3 ">Reminders</p>
       <div className="self-center  text-gray-600 w-[] justify-self-center my-auto mt-10">Guess what ? still working on it</div>
...
const Facts: React.FC = () => {
  return (
    <div className="flex mt-4 gap-6">
      <Fact color="bg-green-200" label="students" value="0">
        <UserIcon className="h-10 text-green-800" />
      </Fact>
      <Fact color="bg-blue-200" label="Teachers" value="0">
        <UserCircleIcon className="h-10 text-blue-800" />
      </Fact>

      <Fact color="bg-yellow-200" label="parents" value="0">
